...
#ifndef CONES_DETECTION__CONES_DETECTION_HPP_
#define CONES_DETECTION__CONES_DETECTION_HPP_
...
class CONES_DETECTION_PUBLIC ConesDetection
{
public:
  ConesDetection();
...
#endif  // CONES_DETECTION__CONES_DETECTION_HPP_
